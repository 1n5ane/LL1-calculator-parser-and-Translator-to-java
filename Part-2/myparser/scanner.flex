...
func_declaration = \){WhiteSpace}*\{
func_identifier = {identifier}{WhiteSpace}*[(]
%state STRING
...
/* operators */
 ...
 "}"            { return symbol(sym.BRACKET_CLOSE); }
 ","            { return symbol(sym.COMMA); }
 {func_declaration} { return symbol(sym.FUNC_DECLARATION); }
 {identifier}       {return symbol(sym.IDENTIFIER,new String(yytext()));}
 /*{func_identifier}  {return symbol(sym.FUNC_IDENTIFIER,new String(yytext()));} */
